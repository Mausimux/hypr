...
hl.bind(mainMod .. " + SHIFT + mouse:273", hl.dsp.window.set_prop({ prop = "keep_aspect_ratio", value = "false" }), { release = true, mouse = true })
...
-- Clipboard history
hl.bind(mainMod .. " + V", hl.dsp.exec_cmd("rofi -modi clipboard:/run/current-system/sw/bin/cliphist-rofi-img -show clipboard -show-icons"))
